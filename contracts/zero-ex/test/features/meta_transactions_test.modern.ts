...
describe('MetaTransactions Feature - Complete Modern Tests', function () {
    ...
    async function createMetaTransactionSignature(mtx: any): Promise<string> {
        ...
        const mtxForHashing = {
            ...
            expirationTimeSeconds: mtx.expirationTimeSeconds?.toString
                ? mtx.expirationTimeSeconds.toString()
    ...
    describe('executeMetaTransaction()', function () {
        ...
        it('fails if the translated call fails', async function () {
            ...
            await expect(feature.connect(sender).executeMetaTransaction(mtx, signature)).to.be.revertedWith(
        ...
        it('reverts if wrong sender', async function () {
            ...
            await expect(feature.connect(notSigner).executeMetaTransaction(mtx, signature)).to.be.revertedWith(
        ...
        it('reverts if bad signature', async function () {
            ...
            await expect(feature.connect(sender).executeMetaTransaction(mtx, invalidSignature)).to.be.revertedWith(
        ...
        it('cannot reduce initial ETH balance', async function () {
            ...
            await expect(feature.connect(sender).executeMetaTransaction(mtx, signature)).to.be.revertedWith('ETH_LEAK');
    ...
    describe('batchExecuteMetaTransactions()', function () {
        ...
        it('cannot reenter `executeMetaTransaction()`', async function () {
            ...
            await expect(feature.connect(sender).batchExecuteMetaTransactions([mtx], [signature])).to.be.revertedWith(
                'IllegalReentrancyError',
            );
