...
export interface BaseBridgeAdapterInterface extends Interface {
  getFunction(nameOrSignature: "isSupportedSource" | "trade"): FunctionFragment;
...
export interface BaseBridgeAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): BaseBridgeAdapter;
  waitForDeployment(): Promise<this>;

  interface: BaseBridgeAdapterInterface;
