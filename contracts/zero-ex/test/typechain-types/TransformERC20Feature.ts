...
export interface TransformERC20FeatureInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FEATURE_NAME"
      | "FEATURE_VERSION"
...
export interface TransformERC20Feature extends BaseContract {
  connect(runner?: ContractRunner | null): TransformERC20Feature;
  waitForDeployment(): Promise<this>;

  interface: TransformERC20FeatureInterface;
