...
export interface PayTakerTransformerInterface extends Interface {
  getFunction(
...
export interface PayTakerTransformer extends BaseContract {
  connect(runner?: ContractRunner | null): PayTakerTransformer;
  waitForDeployment(): Promise<this>;

  interface: PayTakerTransformerInterface;
