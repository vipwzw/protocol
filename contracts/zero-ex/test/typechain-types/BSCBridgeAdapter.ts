...
export interface BSCBridgeAdapterInterface extends Interface {
  getFunction(
...
export interface BSCBridgeAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): BSCBridgeAdapter;
  waitForDeployment(): Promise<this>;

  interface: BSCBridgeAdapterInterface;
