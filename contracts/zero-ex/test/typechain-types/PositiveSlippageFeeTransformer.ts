...
export interface PositiveSlippageFeeTransformerInterface extends Interface {
  getFunction(
...
export interface PositiveSlippageFeeTransformer extends BaseContract {
  connect(runner?: ContractRunner | null): PositiveSlippageFeeTransformer;
  waitForDeployment(): Promise<this>;

  interface: PositiveSlippageFeeTransformerInterface;
