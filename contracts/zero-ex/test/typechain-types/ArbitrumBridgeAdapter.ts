...
export interface ArbitrumBridgeAdapterInterface extends Interface {
  getFunction(
    nameOrSignature: "_tradeGMX" | "_tradeWOOFi" | "isSupportedSource" | "trade"
  ): FunctionFragment;
...
export interface ArbitrumBridgeAdapter extends BaseContract {
  connect(runner?: ContractRunner | null): ArbitrumBridgeAdapter;
  waitForDeployment(): Promise<this>;

  interface: ArbitrumBridgeAdapterInterface;
