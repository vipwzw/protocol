...
export class Erc1155Wrapper {
    ...
    constructor(contractInstance: ERC1155Mintable, contractOwner: string) {
        this._erc1155Contract = contractInstance;
        this._contractOwner = contractOwner;
    }
    public getContract(): ERC1155Mintable {
    ...
    public async mintFungibleTokensAsync(
        ...
        const createFungibleTokenLog = tx.logs[0] as TypedEventLog<ERC1155TransferSingleEventArgs>;
