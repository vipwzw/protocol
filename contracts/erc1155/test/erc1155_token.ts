...
describe('ERC1155Token', () => {
    ...
    before(async () => {
        ...
        fungibleToken = await erc1155Contract
            .connect(ownerSigner)
            .create.staticCall('https://example.com/fungible', false);
        ...
        nonFungibleToken = await erc1155Contract
            .connect(ownerSigner)
            .create.staticCall('https://example.com/nft', true);
        ...
        await erc1155Contract
            .connect(ownerSigner)
            .mintFungible(fungibleToken, [spender], [spenderInitialFungibleBalance]);

        // Mint non-fungible token to spender
        await erc1155Contract.connect(ownerSigner).mintNonFungible(nonFungibleToken, [spender]);
    ...
    describe('safeTransferFrom', () => {
        it('should transfer fungible token if called by token owner', async () => {
            ...
            await erc1155Contract
                ...
                .safeTransferFrom(spender, receiver, fungibleToken, valueToTransfer, receiverCallbackData);
        ...
        it('should trigger callback if transferring to a contract', async () => {
            ...
            const signers = await ethers.getSigners();
            const spenderSigner = signers[1];
            const tx = await erc1155Contract
                .connect(spenderSigner)
                .safeTransferFrom(spender, receiver, tokenToTransfer, valueToTransfer, receiverCallbackData);
    ...
    describe('setApprovalForAll', () => {
        it('should transfer token via safeTransferFrom if called by approved account', async () => {
            ...
            await erc1155Contract
                .connect(delegatedSpenderSigner)
                .safeTransferFrom(spender, receiver, tokenToTransfer, valueToTransfer, receiverCallbackData);
