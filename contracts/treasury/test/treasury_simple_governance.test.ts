...
describe('Treasury Governance (Simplified)', function() {
    ...
    before(async function() {
        ...
        defaultPoolOperator = await TokenFactory.deploy(
            'DefaultPoolOperator',
            'DPO',
            18,
            0
        ...
        treasury = await TokenFactory.deploy(
            'Treasury',
            'TREASURY',
            18,
            0
    ...
    describe('🏛️ Governance Simulation', function() {
        ...
        it('should simulate voting power calculation', async function() {
            ...
            console.log(`📊 Voting Power - Non-Default Pool Split: ${ethers.formatEther(delegatorVotingPowerNonDefault)} + ${ethers.formatEther(operatorVotingPowerNonDefault)} ZRX`);
        });
    ...
    describe('🔐 Security and Permissions', function() {
        ...
        it('should prevent unauthorized treasury access', async function() {
            ...
            await expect(
                weth.connect(relayer).transferFrom(
    ...
    describe('🎯 Integration Scenarios', function() {
        it('should handle multiple concurrent proposals', async function() {
            ...
            const proposal1Passes = (proposal1VotesFor + proposal1VotesAgainst >= QUORUM_THRESHOLD) && 
                                  (proposal1VotesFor > proposal1VotesAgainst);
            const proposal2Passes = (proposal2VotesFor + proposal2VotesAgainst >= QUORUM_THRESHOLD) && 
            ...
            console.log(`   Proposal 1: ${proposal1Passes ? 'PASSED' : 'FAILED'} (Quorum: ${proposal1VotesFor + proposal1VotesAgainst >= QUORUM_THRESHOLD})`);
            console.log(`   Proposal 2: ${proposal2Passes ? 'PASSED' : 'FAILED'} (Quorum: ${proposal2VotesFor + proposal2VotesAgainst >= QUORUM_THRESHOLD})`);
        });
        ...
        it('should demonstrate emergency governance scenario', async function() {
            ...
            console.log(`   Transfer Amount: ${ethers.formatEther(emergencyTransferAmount)} ZRX (${emergencyTransferAmount * BigInt(100) / currentTreasuryBalance}% of treasury)`);
