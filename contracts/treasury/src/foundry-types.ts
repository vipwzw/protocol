...
/**
 * Treasury 包特定的 Foundry Artifacts 接口
 */
export interface TreasuryFoundryArtifacts extends FoundryArtifacts {
    ZrxTreasury: FoundryArtifact;
    DefaultPoolOperator: FoundryArtifact;
}
