...
library LibFillResults {
        ...
        returns (FillResults memory fillResults)
    {
        ...
        fillResults.protocolFeePaid = gasPrice * protocolFeeMultiplier;
        ...
        returns (MatchedFillResults memory matchedFillResults)
    {
        ...
        uint256 protocolFee = gasPrice * protocolFeeMultiplier;
    ...
    {
        totalFillResults.makerAssetFilledAmount = fillResults1.makerAssetFilledAmount + fillResults2.makerAssetFilledAmount;
        totalFillResults.takerAssetFilledAmount = fillResults1.takerAssetFilledAmount + fillResults2.takerAssetFilledAmount;
        totalFillResults.makerFeePaid = fillResults1.makerFeePaid + fillResults2.makerFeePaid;
        totalFillResults.takerFeePaid = fillResults1.takerFeePaid + fillResults2.takerFeePaid;
        totalFillResults.protocolFeePaid = fillResults1.protocolFeePaid + fillResults2.protocolFeePaid;
        ...
        returns (MatchedFillResults memory matchedFillResults)
    {
        ...
        matchedFillResults.profitInLeftMakerAsset = matchedFillResults.left.makerAssetFilledAmount - 
            matchedFillResults.right.takerAssetFilledAmount;
        ...
        returns (MatchedFillResults memory matchedFillResults)
    {
        ...
        if (doesRightMakerAssetProfitExist) {
            matchedFillResults.profitInRightMakerAsset = matchedFillResults.right.makerAssetFilledAmount - 
                matchedFillResults.left.takerAssetFilledAmount;
        }
