...
import "../../erc20/src/interfaces/IERC20Token.sol";
import "../../erc20/src/LibERC20Token.sol";
import "@0x/contracts-exchange-libs/contracts/src/IWallet.sol";
import "@0x/contracts-exchange-libs/contracts/src/LibMath.sol";
// import "@0x/contracts-utils/contracts/src/DeploymentConstants.sol"; // Not needed for modernized version
        ...
        returns (bytes4 success)
    {
        ...
        for (uint256 i = 0; i < state.calls.length; ++i) {
            ...
            // Compute token amounts.
                          uint256 remainingBalance = state.initialInputTokenBalance - state.totalInputTokenSold;
              state.callInputTokenAmount = state.calls[i].inputTokenAmount < remainingBalance
