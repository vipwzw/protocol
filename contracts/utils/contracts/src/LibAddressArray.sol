...
library LibAddressArray {
    ...
    /// @return success True if the addressArray contains the target.
    ...
    /// @param addressArray Array of addresses.
    /// @param target Address to search for in array.
    /// @return success Existence of the target in the array.
    /// @return index Index of the target in the array.
