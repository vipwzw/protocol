...
const assert_utils_1 = require("./assert_utils");
...
class BaseContract {
    ...
    static _assertCallParams(callData, defaultBlock) {
        assert_utils_1.assert.doesConformToSchema('callData', callData, json_schemas_1.schemas.callDataSchema);
        if (defaultBlock !== undefined) {
            assert_utils_1.assert.isBlockParam('defaultBlock', defaultBlock);
        }
    }
