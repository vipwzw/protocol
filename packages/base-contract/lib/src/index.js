...
exports.BaseContract = exports.PromiseWithTransactionHash = exports.methodAbiToFunctionSignature = exports.linkLibrariesInBytecode = exports.SubscriptionErrors = exports.SubscriptionManager = void 0;
var assert_1 = require("@0x/assert");
var json_schemas_1 = require("@0x/json-schemas");
var utils_1 = require("@0x/utils");
var web3_wrapper_1 = require("@0x/web3-wrapper");
var vm_1 = require("@ethereumjs/vm");
...
Object.defineProperty(exports, "linkLibrariesInBytecode", { enumerable: true, get: function () { return utils_3.linkLibrariesInBytecode; } });
Object.defineProperty(exports, "methodAbiToFunctionSignature", { enumerable: true, get: function () { return utils_3.methodAbiToFunctionSignature; } });
...
var BaseContract = /** @class */ (function () {
    ...
    function BaseContract(contractName, abi, address, supportedProvider, callAndTxnDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides) {
        ...
        if (logDecodeDependencies) {
            Object.entries(logDecodeDependencies).forEach(function (_a) {
                var dependencyName = _a[0], dependencyAbi = _a[1];
    ...
    BaseContract._formatABIDataItemList = function (abis, values, formatter) {
        return values.map(function (value, i) { return (0, utils_2.formatABIDataItem)(abis[i], value, formatter); });
    };
        ...
        return new PromiseWithTransactionHash(txHashPromise, (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    return [2 /*return*/, _b.apply(_a, [_c.sent(), opts.pollingIntervalMs,
                            opts.timeoutMs])];
                }
            });
        }); })());
    ...
    BaseContract.prototype._applyDefaultsToTxDataAsync = function (txData, estimateGasAsync) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        txDataWithDefaults = __assign(__assign({ to: this.address }, this._web3Wrapper.getContractDefaults()), BaseContract._removeUndefinedProperties(txData));
                        if (!(txDataWithDefaults.gas === undefined && estimateGasAsync !== undefined)) return [3 /*break*/, 2];
                        _a = txDataWithDefaults;
                        return [4 /*yield*/, estimateGasAsync(txDataWithDefaults)];
                    case 1:
    ...
    BaseContract.prototype._evmExecAsync = function (encodedData) {
        return __awaiter(this, void 0, void 0, function () {
            var encodedDataBytes, toAddress, vm, accountPk, accountAddress, account, contractCode, rawCallResult, callOpts, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        encodedDataBytes = Buffer.from(encodedData.substr(2), 'hex');
                        toAddress = new util.Address(Buffer.from(this.address.substr(2), 'hex'));
                        if (!(this._evmIfExists === undefined)) return [3 /*break*/, 5];
                        vm = new vm_1.default();
                        accountPk = Buffer.from(ARBITRARY_PRIVATE_KEY, 'hex');
                        accountAddress = new util.Address(util.privateToAddress(accountPk));
                        account = util.Account.fromAccountData({ balance: '0xde0b6b3a7640000' });
                        return [4 /*yield*/, vm.stateManager.putAccount(accountAddress, account)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [4 /*yield*/, vm.stateManager.putContractCode(toAddress, this._deployedBytecodeIfExists)];
                    case 4:
                        _a.sent();
                        // save for later
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this._evmIfExists.runCall(callOpts)];
                    case 6:
                        result = _a.sent();
