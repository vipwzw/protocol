...
import { BlockRange, ContractAbi, DecodedLogArgs, LogEntry, LogWithDecodedArgs, RawLog } from 'ethereum-types';
import { EventCallback, IndexedFilterValues } from '@0x/types';
export declare class SubscriptionManager<ContractEventArgs extends DecodedLogArgs, ContractEvents extends string> {
    abi: ContractAbi;
