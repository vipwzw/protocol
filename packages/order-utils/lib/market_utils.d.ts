...
export declare const marketUtils: {
     ...
     */
    findFeeOrdersThatCoverFeesForTargetOrders<T extends Order>(orders: T[], feeOrders: T[], opts?: FindFeeOrdersThatCoverFeesForTargetOrdersOpts): FeeOrdersAndRemainingFeeAmount<T>;
};
