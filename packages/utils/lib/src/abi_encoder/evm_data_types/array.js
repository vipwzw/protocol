...
var ArrayDataType = /** @class */ (function (_super) {
    ...
    function ArrayDataType(dataItem, dataTypeFactory) {
        ...
        // Construct parent
        var isArray = true;
        var _a = ArrayDataType.decodeElementTypeAndLengthFromType(dataItem.type), arrayElementType = _a[0], arrayLength = _a[1];
    ...
    ArrayDataType.decodeElementTypeAndLengthFromType = function (type) {
