...
describe('ABI Encoder: Return Value Encoding/Decoding', function () {
    var DECODE_BEYOND_CALL_DATA_ERROR = 'Tried to decode beyond the end of calldata';
    ...
    describe('Standard encoding/decoding', function () {
        it('No Return Value', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('Single static return value', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('Multiple static return values', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, encodedReturnValue, decodedReturnValue;
            return __generator(this, function (_a) {
        ...
        it('Single dynamic return value', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, encodedReturnValue, decodedReturnValue;
            return __generator(this, function (_a) {
        ...
        it('Multiple dynamic return values', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, encodedReturnValue, decodedReturnValue;
            return __generator(this, function (_a) {
        ...
        it('Mixed static/dynamic return values', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, encodedReturnValue, decodedReturnValue;
            return __generator(this, function (_a) {
        ...
        it('Should decode NULL as default value (single; static)', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it('Should decode NULL as default value (multiple; static)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, decodedReturnValue;
            return __generator(this, function (_a) {
                method = new src_1.AbiEncoder.Method(ReturnValueAbis.multipleStaticReturnValues);
        ...
        it('Should decode NULL as default value (single; dynamic)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, decodedReturnValue;
            return __generator(this, function (_a) {
                method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleDynamicReturnValue);
                returnValue = ['0x'];
    ...
    describe('Strict encoding/decoding', function () {
        ...
        it('Struct should include fields', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, returnValue, encodedReturnValue, decodedReturnValue;
            return __generator(this, function (_a) {
        ...
        it('Should fail to decode NULL (single; static)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, encodedReturnValue, decodeReturnValue;
            return __generator(this, function (_a) {
                method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleStaticReturnValue);
                encodedReturnValue = '0x';
                decodeReturnValue = function () { return method.strictDecodeReturnValue(encodedReturnValue); };
                // Validate decoded return value
                expect(decodeReturnValue).to.throws(DECODE_BEYOND_CALL_DATA_ERROR);
                return [2 /*return*/];
            });
        }); });
        it('Should fail to decode NULL (multiple; static)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, encodedReturnValue, decodeReturnValue;
            return __generator(this, function (_a) {
                method = new src_1.AbiEncoder.Method(ReturnValueAbis.multipleStaticReturnValues);
                encodedReturnValue = '0x';
        ...
        it('Should fail to decode NULL (single; dynamic)', function () { return __awaiter(void 0, void 0, void 0, function () {
            var method, encodedReturnValue, decodeReturnValue;
            return __generator(this, function (_a) {
                method = new src_1.AbiEncoder.Method(ReturnValueAbis.singleDynamicReturnValue);
                encodedReturnValue = '0x';
