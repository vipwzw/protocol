...
const _abi = [
    ...
    },
    {
        ...
        name: 'MetaTransactionExecutedV2',
        type: 'event',
    },
    {
        anonymous: false,
...
export class IZeroEx__factory {
    ...
    static createInterface(): IZeroExInterface {
        return new Interface(_abi) as IZeroExInterface;
    }
    static connect(address: string, runner?: ContractRunner | null): IZeroEx {
        return new Contract(address, _abi, runner) as unknown as IZeroEx;
    }
}
