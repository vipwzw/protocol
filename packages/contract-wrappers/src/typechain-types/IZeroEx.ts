...
export declare namespace LibNFTOrder {
    ...
    export type FeeStructOutput = [recipient: string, amount: bigint, feeData: string] & {
        recipient: string;
        amount: bigint;
        feeData: string;
    };
    ...
    export type PropertyStructOutput = [propertyValidator: string, propertyData: string] & {
...
export declare namespace LibNativeOrder {
    ...
    export type OrderInfoStructOutput = [orderHash: string, status: bigint, takerTokenFilledAmount: bigint] & {
        orderHash: string;
        status: bigint;
...
export declare namespace LibSignature {
    ...
    export type SignatureStructOutput = [signatureType: bigint, v: bigint, r: string, s: string] & {
...
export declare namespace IMultiplexFeature {
    ...
    export type BatchSellSubcallStructOutput = [id: bigint, sellAmount: bigint, data: string] & {
        id: bigint;
        sellAmount: bigint;
        data: string;
    };
...
export declare namespace ITransformERC20Feature {
    ...
    export type TransformationStructOutput = [deploymentNonce: bigint, data: string] & {
...
export declare namespace IMetaTransactionsFeatureV2 {
    ...
    export type MetaTransactionFeeDataStructOutput = [recipient: string, amount: bigint] & {
        recipient: string;
        amount: bigint;
    };
...
export interface IZeroExInterface extends Interface {
    ...
    encodeFunctionData(
        ...
        values: [LibNativeOrder.LimitOrderStruct, LibSignature.SignatureStruct, BigNumberish, AddressLike, AddressLike],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [LibNFTOrder.ERC721OrderStruct[], LibSignature.SignatureStruct[], BytesLike[], boolean],
    ): string;
    ...
    encodeFunctionData(
        ...
        values: [IMetaTransactionsFeatureV2.MetaTransactionDataV2Struct[], LibSignature.SignatureStruct[]],
    ): string;
    encodeFunctionData(
        functionFragment: 'batchFillLimitOrders',
        values: [LibNativeOrder.LimitOrderStruct[], LibSignature.SignatureStruct[], BigNumberish[], boolean],
    ): string;
    encodeFunctionData(
        functionFragment: 'batchFillRfqOrders',
        values: [LibNativeOrder.RfqOrderStruct[], LibSignature.SignatureStruct[], BigNumberish[], boolean],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [LibNFTOrder.ERC1155OrderStruct, LibSignature.SignatureStruct, BigNumberish, BytesLike],
    ): string;
    encodeFunctionData(
        functionFragment: 'buyERC721',
        values: [LibNFTOrder.ERC721OrderStruct, LibSignature.SignatureStruct, BytesLike],
    ): string;
    ...
    encodeFunctionData(functionFragment: 'extend', values: [BytesLike, AddressLike]): string;
    encodeFunctionData(
        functionFragment: 'fillLimitOrder',
        values: [LibNativeOrder.LimitOrderStruct, LibSignature.SignatureStruct, BigNumberish],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [LibNativeOrder.RfqOrderStruct, LibSignature.SignatureStruct, BigNumberish],
    ): string;
    encodeFunctionData(
        functionFragment: 'fillOtcOrder',
        values: [LibNativeOrder.OtcOrderStruct, LibSignature.SignatureStruct, BigNumberish],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'getERC721OrderStatusBitVector', values: [AddressLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'getMetaTransactionV2HashExecutedBlock', values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'isValidOrderSigner', values: [AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: 'lastOtcTxOriginNonce', values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'migrate', values: [AddressLike, BytesLike, AddressLike]): string;
    encodeFunctionData(
        functionFragment: 'multiplexBatchSellEthForToken',
        values: [AddressLike, IMultiplexFeature.BatchSellSubcallStruct[], BigNumberish],
    ): string;
    encodeFunctionData(
        functionFragment: 'multiplexBatchSellTokenForEth',
        values: [AddressLike, IMultiplexFeature.BatchSellSubcallStruct[], BigNumberish, BigNumberish],
    ): string;
    encodeFunctionData(
        functionFragment: 'multiplexBatchSellTokenForToken',
        values: [AddressLike, AddressLike, IMultiplexFeature.BatchSellSubcallStruct[], BigNumberish, BigNumberish],
    ): string;
    encodeFunctionData(
        functionFragment: 'multiplexMultiHopSellEthForToken',
        values: [AddressLike[], IMultiplexFeature.MultiHopSellSubcallStruct[], BigNumberish],
    ): string;
    encodeFunctionData(
        functionFragment: 'multiplexMultiHopSellTokenForEth',
        values: [AddressLike[], IMultiplexFeature.MultiHopSellSubcallStruct[], BigNumberish, BigNumberish],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'registerAllowedOrderSigner', values: [AddressLike, boolean]): string;
    encodeFunctionData(functionFragment: 'registerAllowedRfqOrigins', values: [AddressLike[], boolean]): string;
    encodeFunctionData(functionFragment: 'rollback', values: [BytesLike, AddressLike]): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [LibNFTOrder.ERC721OrderStruct, LibSignature.SignatureStruct, BigNumberish, boolean, BytesLike],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [AddressLike, AddressLike, AddressLike, AddressLike, BigNumberish, BigNumberish, BytesLike],
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(functionFragment: 'setQuoteSigner', values: [AddressLike]): string;
    encodeFunctionData(functionFragment: 'setTransformerDeployer', values: [AddressLike]): string;
    ...
    encodeFunctionData(
        ...
        values: [AddressLike, AddressLike, BigNumberish, BigNumberish, ITransformERC20Feature.TransformationStruct[]],
    ): string;
    encodeFunctionData(
    ...
    decodeFunctionResult(functionFragment: '_multiplexBatchSell', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: '_multiplexMultiHopSell', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: '_sellHeldTokenForTokenToUniswapV3', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: '_sellTokenForTokenToUniswapV3', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'batchExecuteMetaTransactionsV2', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'executeMetaTransactionV2', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'getMetaTransactionV2ExecutedBlock', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'getMetaTransactionV2Hash', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'getMetaTransactionV2HashExecutedBlock', data: BytesLike): Result;
...
export namespace MetaTransactionExecutedEvent {
    export type InputTuple = [hash: BytesLike, selector: BytesLike, signer: AddressLike, sender: AddressLike];
    export type OutputTuple = [hash: string, selector: string, signer: string, sender: string];
    export interface OutputObject {
        hash: string;
        selector: string;
        signer: string;
...
export namespace MigratedEvent {
    export type InputTuple = [caller: AddressLike, migrator: AddressLike, newOwner: AddressLike];
    export type OutputTuple = [caller: string, migrator: string, newOwner: string];
    export interface OutputObject {
        caller: string;
        migrator: string;
        newOwner: string;
...
export namespace OrderSignerRegisteredEvent {
    export type InputTuple = [maker: AddressLike, signer: AddressLike, allowed: boolean];
...
export namespace PairCancelledLimitOrdersEvent {
    ...
    export type OutputTuple = [maker: string, makerToken: string, takerToken: string, minValidSalt: bigint];
    export interface OutputObject {
        maker: string;
        makerToken: string;
        takerToken: string;
...
export namespace ProxyFunctionUpdatedEvent {
    export type InputTuple = [selector: BytesLike, oldImpl: AddressLike, newImpl: AddressLike];
    export type OutputTuple = [selector: string, oldImpl: string, newImpl: string];
    export interface OutputObject {
        selector: string;
        oldImpl: string;
        newImpl: string;
...
export namespace RfqOrderOriginsAllowedEvent {
    export type InputTuple = [origin: AddressLike, addrs: AddressLike[], allowed: boolean];
...
export interface IZeroEx extends BaseContract {
    ...
    _multiplexBatchSell: TypedContractMethod<
        [params: IMultiplexFeature.BatchSellParamsStruct, minBuyAmount: BigNumberish],
        [bigint],
        'nonpayable'
    >;

    _multiplexMultiHopSell: TypedContractMethod<
        [params: IMultiplexFeature.MultiHopSellParamsStruct, minBuyAmount: BigNumberish],
        [bigint],
        'nonpayable'
    >;

    _sellHeldTokenForTokenToUniswapV3: TypedContractMethod<
        [encodedPath: BytesLike, sellAmount: BigNumberish, minBuyAmount: BigNumberish, recipient: AddressLike],
        [bigint],
        'nonpayable'
    >;
    ...
    _transformERC20: TypedContractMethod<[args: ITransformERC20Feature.TransformERC20ArgsStruct], [bigint], 'payable'>;
    ...
    batchCancelERC1155Orders: TypedContractMethod<[orderNonces: BigNumberish[]], [void], 'nonpayable'>;

    batchCancelERC721Orders: TypedContractMethod<[orderNonces: BigNumberish[]], [void], 'nonpayable'>;

    batchCancelLimitOrders: TypedContractMethod<[orders: LibNativeOrder.LimitOrderStruct[]], [void], 'nonpayable'>;

    batchCancelPairLimitOrders: TypedContractMethod<
        [makerTokens: AddressLike[], takerTokens: AddressLike[], minValidSalts: BigNumberish[]],
        [void],
        'nonpayable'
    >;

    batchCancelPairLimitOrdersWithSigner: TypedContractMethod<
        [maker: AddressLike, makerTokens: AddressLike[], takerTokens: AddressLike[], minValidSalts: BigNumberish[]],
        [void],
        'nonpayable'
    >;
    ...
    batchCancelRfqOrders: TypedContractMethod<[orders: LibNativeOrder.RfqOrderStruct[]], [void], 'nonpayable'>;

    batchExecuteMetaTransactions: TypedContractMethod<
        [mtxs: IMetaTransactionsFeature.MetaTransactionDataStruct[], signatures: LibSignature.SignatureStruct[]],
        [string[]],
        'payable'
    >;

    batchExecuteMetaTransactionsV2: TypedContractMethod<
        [mtxs: IMetaTransactionsFeatureV2.MetaTransactionDataV2Struct[], signatures: LibSignature.SignatureStruct[]],
        [string[]],
        'nonpayable'
    >;
    ...
    batchGetLimitOrderRelevantStates: TypedContractMethod<
        [orders: LibNativeOrder.LimitOrderStruct[], signatures: LibSignature.SignatureStruct[]],
        [
    ...
    batchGetRfqOrderRelevantStates: TypedContractMethod<
        [orders: LibNativeOrder.RfqOrderStruct[], signatures: LibSignature.SignatureStruct[]],
        [
            [LibNativeOrder.OrderInfoStructOutput[], bigint[], boolean[]] & {
                orderInfos: LibNativeOrder.OrderInfoStructOutput[];
                actualFillableTakerTokenAmounts: bigint[];
    ...
    buyERC721: TypedContractMethod<
        [sellOrder: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct, callbackData: BytesLike],
        [void],
        'payable'
    >;

    cancelERC1155Order: TypedContractMethod<[orderNonce: BigNumberish], [void], 'nonpayable'>;

    cancelERC721Order: TypedContractMethod<[orderNonce: BigNumberish], [void], 'nonpayable'>;

    cancelLimitOrder: TypedContractMethod<[order: LibNativeOrder.LimitOrderStruct], [void], 'nonpayable'>;

    cancelPairLimitOrders: TypedContractMethod<
        [makerToken: AddressLike, takerToken: AddressLike, minValidSalt: BigNumberish],
        [void],
        'nonpayable'
    >;

    cancelPairLimitOrdersWithSigner: TypedContractMethod<
        [maker: AddressLike, makerToken: AddressLike, takerToken: AddressLike, minValidSalt: BigNumberish],
        [void],
        'nonpayable'
    >;
    ...
    cancelRfqOrder: TypedContractMethod<[order: LibNativeOrder.RfqOrderStruct], [void], 'nonpayable'>;

    createTransformWallet: TypedContractMethod<[], [string], 'nonpayable'>;

    executeMetaTransaction: TypedContractMethod<
        [mtx: IMetaTransactionsFeature.MetaTransactionDataStruct, signature: LibSignature.SignatureStruct],
        [string],
        'payable'
    >;

    executeMetaTransactionV2: TypedContractMethod<
        [mtx: IMetaTransactionsFeatureV2.MetaTransactionDataV2Struct, signature: LibSignature.SignatureStruct],
        [string],
        'nonpayable'
    >;

    extend: TypedContractMethod<[selector: BytesLike, impl: AddressLike], [void], 'nonpayable'>;
    ...
    fillOtcOrderWithEth: TypedContractMethod<
        [order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct],
        [
            [bigint, bigint] & {
                takerTokenFilledAmount: bigint;
                makerTokenFilledAmount: bigint;
    ...
    getERC1155OrderHash: TypedContractMethod<[order: LibNFTOrder.ERC1155OrderStruct], [string], 'view'>;
    ...
    getERC721OrderHash: TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct], [string], 'view'>;

    getERC721OrderStatus: TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct], [bigint], 'view'>;
    ...
    getLimitOrderHash: TypedContractMethod<[order: LibNativeOrder.LimitOrderStruct], [string], 'view'>;
    ...
    getLimitOrderRelevantState: TypedContractMethod<
        [order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct],
        [
            [LibNativeOrder.OrderInfoStructOutput, bigint, boolean] & {
    ...
    getMetaTransactionHashExecutedBlock: TypedContractMethod<[mtxHash: BytesLike], [bigint], 'view'>;
    ...
    getMetaTransactionV2HashExecutedBlock: TypedContractMethod<[mtxHash: BytesLike], [bigint], 'view'>;

    getOtcOrderHash: TypedContractMethod<[order: LibNativeOrder.OtcOrderStruct], [string], 'view'>;
    ...
    getRfqOrderHash: TypedContractMethod<[order: LibNativeOrder.RfqOrderStruct], [string], 'view'>;
    ...
    getRfqOrderRelevantState: TypedContractMethod<
        [order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct],
        [
            [LibNativeOrder.OrderInfoStructOutput, bigint, boolean] & {
                orderInfo: LibNativeOrder.OrderInfoStructOutput;
                actualFillableTakerTokenAmount: bigint;
    ...
    getRollbackEntryAtIndex: TypedContractMethod<[selector: BytesLike, idx: BigNumberish], [string], 'view'>;

    getRollbackLength: TypedContractMethod<[selector: BytesLike], [bigint], 'view'>;

    getTransformWallet: TypedContractMethod<[], [string], 'view'>;

    getTransformerDeployer: TypedContractMethod<[], [string], 'view'>;

    isValidOrderSigner: TypedContractMethod<[maker: AddressLike, signer: AddressLike], [boolean], 'view'>;

    lastOtcTxOriginNonce: TypedContractMethod<[txOrigin: AddressLike, nonceBucket: BigNumberish], [bigint], 'view'>;
    ...
    migrate: TypedContractMethod<[target: AddressLike, data: BytesLike, newOwner: AddressLike], [void], 'nonpayable'>;

    multiplexBatchSellEthForToken: TypedContractMethod<
        [outputToken: AddressLike, calls: IMultiplexFeature.BatchSellSubcallStruct[], minBuyAmount: BigNumberish],
        [bigint],
        'payable'
    >;
    ...
    multiplexMultiHopSellEthForToken: TypedContractMethod<
        [tokens: AddressLike[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], minBuyAmount: BigNumberish],
        [bigint],
        'payable'
    >;
    ...
    onERC1155Received: TypedContractMethod<
        [operator: AddressLike, from: AddressLike, tokenId: BigNumberish, value: BigNumberish, data: BytesLike],
        [string],
        'nonpayable'
    >;
    ...
    preSignERC1155Order: TypedContractMethod<[order: LibNFTOrder.ERC1155OrderStruct], [void], 'nonpayable'>;

    preSignERC721Order: TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct], [void], 'nonpayable'>;

    registerAllowedOrderSigner: TypedContractMethod<[signer: AddressLike, allowed: boolean], [void], 'nonpayable'>;

    registerAllowedRfqOrigins: TypedContractMethod<[origins: AddressLike[], allowed: boolean], [void], 'nonpayable'>;

    rollback: TypedContractMethod<[selector: BytesLike, targetImpl: AddressLike], [void], 'nonpayable'>;
    ...
    sellEthForTokenToUniswapV3: TypedContractMethod<
        [encodedPath: BytesLike, minBuyAmount: BigNumberish, recipient: AddressLike],
        [bigint],
        'payable'
    >;
    ...
    sellToPancakeSwap: TypedContractMethod<
        [tokens: AddressLike[], sellAmount: BigNumberish, minBuyAmount: BigNumberish, fork: BigNumberish],
        [bigint],
        'payable'
    >;

    sellToUniswap: TypedContractMethod<
        [tokens: AddressLike[], sellAmount: BigNumberish, minBuyAmount: BigNumberish, isSushi: boolean],
        [bigint],
        'payable'
    >;
    ...
    setQuoteSigner: TypedContractMethod<[quoteSigner: AddressLike], [void], 'nonpayable'>;

    setTransformerDeployer: TypedContractMethod<[transformerDeployer: AddressLike], [void], 'nonpayable'>;

    supportInterface: TypedContractMethod<[interfaceId: BytesLike], [boolean], 'view'>;

    transferOwnership: TypedContractMethod<[newOwner: AddressLike], [void], 'nonpayable'>;

    transferProtocolFeesForPools: TypedContractMethod<[poolIds: BytesLike[]], [void], 'nonpayable'>;
    ...
    validateERC1155OrderSignature: TypedContractMethod<
        [order: LibNFTOrder.ERC1155OrderStruct, signature: LibSignature.SignatureStruct],
        [void],
        'view'
    >;
    ...
    validateERC721OrderSignature: TypedContractMethod<
        [order: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct],
        [void],
        'view'
    >;
    ...
    getFunction(nameOrSignature: '_fillLimitOrder'): TypedContractMethod<
        [
            order: LibNativeOrder.LimitOrderStruct,
            signature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
        ...
        'payable'
    >;
    getFunction(nameOrSignature: '_fillOtcOrder'): TypedContractMethod<
        [
            order: LibNativeOrder.OtcOrderStruct,
            makerSignature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
        ...
        'nonpayable'
    >;
    getFunction(nameOrSignature: '_fillRfqOrder'): TypedContractMethod<
        [
            order: LibNativeOrder.RfqOrderStruct,
            signature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
    ...
    ): TypedContractMethod<[args: ITransformERC20Feature.TransformERC20ArgsStruct], [bigint], 'payable'>;
    getFunction(
    ...
    ): TypedContractMethod<[orders: LibNativeOrder.LimitOrderStruct[]], [void], 'nonpayable'>;
    getFunction(
    ...
    ): TypedContractMethod<[orders: LibNativeOrder.RfqOrderStruct[]], [void], 'nonpayable'>;
    getFunction(
    ...
    getFunction(
        ...
        'nonpayable'
    >;
    getFunction(nameOrSignature: 'batchFillLimitOrders'): TypedContractMethod<
        [
            orders: LibNativeOrder.LimitOrderStruct[],
            signatures: LibSignature.SignatureStruct[],
            takerTokenFillAmounts: BigNumberish[],
        ...
        'payable'
    >;
    getFunction(nameOrSignature: 'batchFillRfqOrders'): TypedContractMethod<
        [
            orders: LibNativeOrder.RfqOrderStruct[],
            signatures: LibSignature.SignatureStruct[],
            takerTokenFillAmounts: BigNumberish[],
    ...
    getFunction(
        ...
        'nonpayable'
    >;
    getFunction(nameOrSignature: 'batchGetLimitOrderRelevantStates'): TypedContractMethod<
        [orders: LibNativeOrder.LimitOrderStruct[], signatures: LibSignature.SignatureStruct[]],
        [
            [LibNativeOrder.OrderInfoStructOutput[], bigint[], boolean[]] & {
                orderInfos: LibNativeOrder.OrderInfoStructOutput[];
        ...
        'view'
    >;
    getFunction(nameOrSignature: 'batchGetRfqOrderRelevantStates'): TypedContractMethod<
        [orders: LibNativeOrder.RfqOrderStruct[], signatures: LibSignature.SignatureStruct[]],
        [
            [LibNativeOrder.OrderInfoStructOutput[], bigint[], boolean[]] & {
                orderInfos: LibNativeOrder.OrderInfoStructOutput[];
    ...
    ): TypedContractMethod<[order: LibNativeOrder.LimitOrderStruct], [void], 'nonpayable'>;
    getFunction(
    ...
    ): TypedContractMethod<[order: LibNativeOrder.RfqOrderStruct], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'createTransformWallet'): TypedContractMethod<[], [string], 'nonpayable'>;
    getFunction(
    ...
    ): TypedContractMethod<[selector: BytesLike, impl: AddressLike], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'fillLimitOrder'): TypedContractMethod<
        [
            order: LibNativeOrder.LimitOrderStruct,
            signature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
    ...
    getFunction(
        ...
        'nonpayable'
    >;
    getFunction(nameOrSignature: 'fillOtcOrder'): TypedContractMethod<
        [
            order: LibNativeOrder.OtcOrderStruct,
            makerSignature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
        ...
        'nonpayable'
    >;
    getFunction(nameOrSignature: 'fillOtcOrderForEth'): TypedContractMethod<
        [
            order: LibNativeOrder.OtcOrderStruct,
            makerSignature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
        ...
        'nonpayable'
    >;
    getFunction(nameOrSignature: 'fillOtcOrderWithEth'): TypedContractMethod<
        [order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct],
        [
            [bigint, bigint] & {
                takerTokenFilledAmount: bigint;
        ...
        'payable'
    >;
    getFunction(nameOrSignature: 'fillRfqOrder'): TypedContractMethod<
        [
            order: LibNativeOrder.RfqOrderStruct,
            signature: LibSignature.SignatureStruct,
            takerTokenFillAmount: BigNumberish,
    ...
    ): TypedContractMethod<[order: LibNFTOrder.ERC1155OrderStruct], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getERC1155OrderInfo',
    ): TypedContractMethod<[order: LibNFTOrder.ERC1155OrderStruct], [LibNFTOrder.OrderInfoStructOutput], 'view'>;
    getFunction(
        nameOrSignature: 'getERC721OrderHash',
    ): TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getERC721OrderStatus',
    ): TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct], [bigint], 'view'>;
    getFunction(
        nameOrSignature: 'getERC721OrderStatusBitVector',
    ): TypedContractMethod<[maker: AddressLike, nonceRange: BigNumberish], [bigint], 'view'>;
    getFunction(
        nameOrSignature: 'getLimitOrderHash',
    ): TypedContractMethod<[order: LibNativeOrder.LimitOrderStruct], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getLimitOrderInfo',
    ): TypedContractMethod<[order: LibNativeOrder.LimitOrderStruct], [LibNativeOrder.OrderInfoStructOutput], 'view'>;
    getFunction(nameOrSignature: 'getLimitOrderRelevantState'): TypedContractMethod<
        [order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct],
        [
            [LibNativeOrder.OrderInfoStructOutput, bigint, boolean] & {
                orderInfo: LibNativeOrder.OrderInfoStructOutput;
    ...
    ): TypedContractMethod<[mtx: IMetaTransactionsFeature.MetaTransactionDataStruct], [bigint], 'view'>;
    getFunction(
        nameOrSignature: 'getMetaTransactionHash',
    ): TypedContractMethod<[mtx: IMetaTransactionsFeature.MetaTransactionDataStruct], [string], 'view'>;
    getFunction(
    ...
    ): TypedContractMethod<[mtx: IMetaTransactionsFeatureV2.MetaTransactionDataV2Struct], [bigint], 'view'>;
    getFunction(
        nameOrSignature: 'getMetaTransactionV2Hash',
    ): TypedContractMethod<[mtx: IMetaTransactionsFeatureV2.MetaTransactionDataV2Struct], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getMetaTransactionV2HashExecutedBlock',
    ): TypedContractMethod<[mtxHash: BytesLike], [bigint], 'view'>;
    getFunction(
        nameOrSignature: 'getOtcOrderHash',
    ): TypedContractMethod<[order: LibNativeOrder.OtcOrderStruct], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getOtcOrderInfo',
    ): TypedContractMethod<[order: LibNativeOrder.OtcOrderStruct], [LibNativeOrder.OtcOrderInfoStructOutput], 'view'>;
    getFunction(nameOrSignature: 'getProtocolFeeMultiplier'): TypedContractMethod<[], [bigint], 'view'>;
    getFunction(nameOrSignature: 'getQuoteSigner'): TypedContractMethod<[], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getRfqOrderHash',
    ): TypedContractMethod<[order: LibNativeOrder.RfqOrderStruct], [string], 'view'>;
    getFunction(
        nameOrSignature: 'getRfqOrderInfo',
    ): TypedContractMethod<[order: LibNativeOrder.RfqOrderStruct], [LibNativeOrder.OrderInfoStructOutput], 'view'>;
    getFunction(nameOrSignature: 'getRfqOrderRelevantState'): TypedContractMethod<
        [order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct],
        [
            [LibNativeOrder.OrderInfoStructOutput, bigint, boolean] & {
                orderInfo: LibNativeOrder.OrderInfoStructOutput;
    ...
    ): TypedContractMethod<[selector: BytesLike, idx: BigNumberish], [string], 'view'>;
    getFunction(nameOrSignature: 'getRollbackLength'): TypedContractMethod<[selector: BytesLike], [bigint], 'view'>;
    getFunction(nameOrSignature: 'getTransformWallet'): TypedContractMethod<[], [string], 'view'>;
    getFunction(nameOrSignature: 'getTransformerDeployer'): TypedContractMethod<[], [string], 'view'>;
    getFunction(
        nameOrSignature: 'isValidOrderSigner',
    ): TypedContractMethod<[maker: AddressLike, signer: AddressLike], [boolean], 'view'>;
    getFunction(
        nameOrSignature: 'lastOtcTxOriginNonce',
    ): TypedContractMethod<[txOrigin: AddressLike, nonceBucket: BigNumberish], [bigint], 'view'>;
    getFunction(
    ...
    ): TypedContractMethod<[target: AddressLike, data: BytesLike, newOwner: AddressLike], [void], 'nonpayable'>;
    getFunction(
    ...
    ): TypedContractMethod<[order: LibNFTOrder.ERC1155OrderStruct], [void], 'nonpayable'>;
    getFunction(
        nameOrSignature: 'preSignERC721Order',
    ): TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct], [void], 'nonpayable'>;
    getFunction(
        nameOrSignature: 'registerAllowedOrderSigner',
    ): TypedContractMethod<[signer: AddressLike, allowed: boolean], [void], 'nonpayable'>;
    getFunction(
        nameOrSignature: 'registerAllowedRfqOrigins',
    ): TypedContractMethod<[origins: AddressLike[], allowed: boolean], [void], 'nonpayable'>;
    getFunction(
        nameOrSignature: 'rollback',
    ): TypedContractMethod<[selector: BytesLike, targetImpl: AddressLike], [void], 'nonpayable'>;
    getFunction(
    ...
    ): TypedContractMethod<[transformerDeployer: AddressLike], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'supportInterface'): TypedContractMethod<[interfaceId: BytesLike], [boolean], 'view'>;
    getFunction(
    ...
    ): TypedContractMethod<[order: LibNFTOrder.ERC1155OrderStruct, erc1155TokenId: BigNumberish], [void], 'view'>;
    getFunction(
    ...
    ): TypedContractMethod<[order: LibNFTOrder.ERC721OrderStruct, erc721TokenId: BigNumberish], [void], 'view'>;
    getFunction(
    ...
    getEvent(
        key: 'Migrated',
    ): TypedContractEvent<MigratedEvent.InputTuple, MigratedEvent.OutputTuple, MigratedEvent.OutputObject>;
    getEvent(
        key: 'OrderCancelled',
    ): TypedContractEvent<
