...
export interface IZrxTreasuryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "castVote"
      | "castVoteBySignature"
...
export interface IZrxTreasury extends BaseContract {
  connect(runner?: ContractRunner | null): IZrxTreasury;
  waitForDeployment(): Promise<this>;

  interface: IZrxTreasuryInterface;
