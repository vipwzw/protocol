...
export interface IEtherTokenInterface extends Interface {
    getFunction(
        nameOrSignature:
            | 'allowance'
            | 'approve'
...
export interface IEtherToken extends BaseContract {
    connect(runner?: ContractRunner | null): IEtherToken;
    waitForDeployment(): Promise<this>;

    interface: IEtherTokenInterface;
