...
export interface UnlimitedAllowanceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface UnlimitedAllowanceToken extends BaseContract {
  connect(runner?: ContractRunner | null): UnlimitedAllowanceToken;
  waitForDeployment(): Promise<this>;

  interface: UnlimitedAllowanceTokenInterface;
