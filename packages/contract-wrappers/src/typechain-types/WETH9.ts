...
export namespace DepositEvent {
    export type InputTuple = [_owner: AddressLike, _value: BigNumberish];
    export type OutputTuple = [_owner: string, _value: bigint];
    export interface OutputObject {
        _owner: string;
        _value: bigint;
    }
...
export interface WETH9 extends BaseContract {
    ...
    ): TypedContractMethod<[src: AddressLike, dst: AddressLike, wad: BigNumberish], [boolean], 'nonpayable'>;
